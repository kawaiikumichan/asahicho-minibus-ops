...
英国のサッカーアカデミー（マンチェスターUなど）で採用されている指標です。
...
## 📝 コーチの観察ポイント
私たちは、シュートが入ったかどうか（Competence）だけでなく、以下のようなシーンを評価し、褒めます。

1.  **Connection:** ミスをした仲間に「ドンマイ」と声をかけているか？
2.  **Creativity:** 自分のマークマンが強い時、工夫して守ろうとしているか？
3.  **Character:** 審判や相手チームに敬意を払っているか？
